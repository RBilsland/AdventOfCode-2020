                ...
                for (int columnDifference = -1; columnDifference < 2; columnDifference++)
                {
                    ...
                    else
                    {
                        ...
                        while (seatStatus == '.')
                        {
                            ...
                            seatStatus = GetSeatStatus(rowPosition + (rowDifference * multiplier), columnPosition + (columnDifference * multiplier));
                        }

                        neighbours += seatStatus;
                    }
                }
            }
